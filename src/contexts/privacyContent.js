...
const content = {
  ar: `<h1>سياسة الخصوصية</h1>
      ...
      <p>يستخدم هذا الموقع Google AdSense لعرض الإعلانات. قد تستخدم Google وشركاؤها ملفات تعريف الارتباط (Cookies) ومعرّفات الإعلانات لعرض إعلانات مخصّصة بناءً على زياراتك لهذا الموقع ومواقع أخرى. يمكنك التحكم بتخصيص الإعلانات أو إلغاء تفعيله من <a href="https://adssettings.google.com" target="_blank" rel="noopener">إعدادات إعلانات Google</a>. لمزيد من التفاصيل حول كيفية استخدام Google للبيانات، راجع <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener">سياسة شركاء Google</a>.</p>
      <h2>حقوقك</h2>
  ...
  en: `<h1>Privacy Policy</h1>
      ...
      <p>This website uses Google AdSense to display ads. Google and its partners may use cookies and advertising identifiers to show personalized ads based on your visits to this and other sites. You can manage or opt out of ad personalization at <a href="https://adssettings.google.com" target="_blank" rel="noopener">Google Ads Settings</a>. For more on how Google uses data, see the <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener">Google Partner Sites Policy</a>.</p>
      <h2>Your Rights</h2>
  ...
  es: `<h1>Política de Privacidad</h1>
      ...
      <p>Este sitio usa Google AdSense para mostrar anuncios. Google y sus socios pueden usar cookies e identificadores publicitarios para mostrar anuncios personalizados según tus visitas a este y otros sitios. Puedes gestionar o desactivar la personalización de anuncios en <a href="https://adssettings.google.com" target="_blank" rel="noopener">Configuración de anuncios de Google</a>. Más información en la <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener">Política de sitios asociados de Google</a>.</p>
      <h2>Tus Derechos</h2>
  ...
  ru: `<h1>Политика конфиденциальности</h1>
      ...
      <h2>Реклама и файлы cookie</h2>
      <p>Этот сайт использует Google AdSense для показа рекламы. Google и её партнёры могут использовать файлы cookie и рекламные идентификаторы для показа персонализированной рекламы на основе ваших посещений этого и других сайтов. Вы можете управлять персонализацией рекламы в <a href="https://adssettings.google.com" target="_blank" rel="noopener">настройках рекламы Google</a>. Подробнее — в <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener">политике партнёрских сайтов Google</a>.</p>
      <h2>Ваши права</h2>
